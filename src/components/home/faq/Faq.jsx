  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center">
        ...
        <motion.div 
          ref={imageRef}
          className="w-[35%] relative flex justify-end mt-10 max-h-[560px]"
          initial={{ opacity: 0, x: -100 }}
          animate={imageInView ? { opacity: 1, x: 0 } : {}}
          transition={{ duration: 0.8, delay: 0.3, ease: "easeOut" }}
        >
          <motion.div 
            className="bg-[linear-gradient(to_bottom,#3E89C8,#95C83E)] w-1/2 h-full absolute rounded-4xl top-4 z-0 left-10"
