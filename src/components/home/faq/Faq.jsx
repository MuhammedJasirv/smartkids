    ...
    >
      ...
      >
        <div className="flex gap-2 items-center">
          ...
          <p className="text-white font-semibold font-sans text-sm md:text-3xl">{question}</p>
        </div>
        <motion.div
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <p className="text-gray-800 text-xs md:text-base font-medium leading-relaxed">{content}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </motion.div>
