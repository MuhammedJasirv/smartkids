...
const Footer = ({ Colour = "#003041", pt = "0" }) => {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-50px" });

  return (
    <motion.footer
      className={`w-full text-white transition-all duration-500 md:pt-${pt}`}
    ...
    >
      ...
      >
        ...
        >
          <img
            src={Logo}
            className="w-[105px] h-[105px] xs:w-20 xs:h-20"
            alt="Logo"
          />
          <p className="text-lg md:text-xl font-sans  sm:text-sm">CALL US</p>
          <p className="text-lg md:text-2xl font-sans  sm:text-sm">
            +91 9099 990 999
          </p>
        </motion.div>
        ...
        >
          <img
            src={Logo}
            className="max-w-[105px] hidden lg:block invisible lg:invisible"
            alt="Logo"
          />
          <p className="text-lg md:text-xl font-sans  sm:text-sm">MAIL US</p>
          <p className="text-lg md:text-2xl font-sans  sm:text-sm">
            pocketmoney@gmail.com
          </p>
        </motion.div>
        ...
        >
          <p className="text-xl md:text-2xl sm:text-base font-sans">
            Download Our App
          </p>
          <motion.img
            src={Store}
      ...
      >
        <p className="text-lg md:text-base sm:text-sm m-auto md:m-0">
          © 2024 Ivory technologies
        </p>
        <motion.div
